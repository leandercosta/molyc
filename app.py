...
try:
    sqliteConnection = sqlite3.connect('registers.sqlite')
                ...
                for i in persons:
                    if abs(x-i.getX()) <= w and abs(y-i.getY()) <= h:
                        ...
                        if i.going_UP(line_down,line_up) == True:
                            ...
                            sqlite = """INSERT INTO registers (idClient,idSpot,action,datetime) VALUES (1,1,'ENTRADA','""" + time.strftime("%c") + """')"""
                            ...
                            sqlite = """INSERT INTO registers (idClient,idSpot,action,datetime) VALUES (1,1,'SAIDA','""" + time.strftime("%c") + """')"""
                            count = cursor.execute(sqlite)
                            sqliteConnection.commit()
                            print("GRAVADO!", cursor.rowcount)
